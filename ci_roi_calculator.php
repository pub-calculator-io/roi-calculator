...
Version: 1.0.0
Author: Return on Investment (ROI) Calculator / www.calculator.io
...
function display_calcio_ci_roi_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_roi_calculator', 'display_calcio_ci_roi_calculator' );